...
func (l *LibcontainerBackend) mountTmpfs(m *host.Mountspec) (string, error) {
	...
	vol, err := l.vman.ImportVolume("default", sparse.NewBufferedFileIoProcessorByFP(l.defaultTmpfs), &volume.Info{
		ID:        volID,
...
func createTmpfs(size int64) (*os.File, error) {
